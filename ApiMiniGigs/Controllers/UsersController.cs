...
namespace ApiMiniGigs.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        public async Task<ActionResult<string>> Login([FromBody] LoginModel loginModel)
        {
            ...
            // Хэшируем введенный пароль с использованием соли пользователя и сравниваем его с хэшированным паролем в базе данных
            var hashedPassword = PasswordHelper.HashPassword(loginModel.Password, user.Salt);
        ...
        public async Task<ActionResult<User>> Register(User user)
        {
            ...
            // Сохраняем соль и хэшированный пароль в объект пользователя
            user.Salt = salt;
