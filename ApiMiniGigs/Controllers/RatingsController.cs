...
namespace ApiMiniGigs.Controllers
{
    ...
    public class RatingsController : ControllerBase
    {
        ...
        public RatingsController(MiniGigsDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Rating>> PostRating(Rating rating)
        {
          if (_context.Ratings == null)
          {
              return Problem("Entity set 'MiniGigsDBContext.Ratings'  is null.");
          }
        ...
        {
            return (_context.Ratings?.Any(e => e.IdRating == id)).GetValueOrDefault();
        }
    }
}
